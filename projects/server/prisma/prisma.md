...
## Commands
- `prisma db push` is useful for prototyping database changes without creating any migrations (i.e. for prototyping). See https://www.prisma.io/docs/orm/prisma-migrate/workflows/prototyping-your-schema
...
- logging queries for performance debugging: https://www.prisma.io/docs/orm/prisma-client/observability-and-logging/logging#event-based-logging
...
See https://www.prisma.io/docs/orm/prisma-client/queries/relation-queries for examples.
