...
## Local S3
ChatMate connects to a local S3 server called MinIO. Download it [here](https://min.io/download) and reference the path in the `MINIO_PATH` environment variable. The MinIO process starts automatically when running ChatMate locally.
