...
// this will NOT work if providing partial items to a nested array, only if `T` itself is of type array. to get around this, call expectObject on the nested array as well.
