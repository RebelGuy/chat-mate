...
describe(text.getLiveId, () => {
  ...
  test('invalid throws error', () => expect(() => text.getLiveId('TriRgpNd-s')).toThrow())
})
...
describe(text.toConstCase, () => {
  ...
  test('multiple words throws error', () => expect(() => text.toConstCase('hello world')).toThrow())
})
...
describe(text.toCamelCase, () => {
  ...
  test('multiple words throws error', () => expect(() => text.toCamelCase('hello world')).toThrow())
})
